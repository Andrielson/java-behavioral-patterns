package com.github.andrielson.command.alexa.before.alexa;

import java.util.HashMap;
import java.util.Map;

import com.github.andrielson.command.alexa.before.lights.PhillipsHueLight;
import com.github.andrielson.command.alexa.before.lights.XiaomiLight;
